...
public class Proveedor {
	...
	public Proveedor(int codigo, String nombre, String cif, String codigoPostal, String pais, String nombreContacto,
			...
			String tipoIVA, String tipoPago, String plazoPago, String numeroCuenta) {
		this.codigo = codigo;
		this.nombre = nombre;
		this.cif = cif;
	...
	public String toString() {
		return "Proveedor [codigo=" + codigo + ", nombre=" + nombre + ", cif=" + cif + ", codigoPostal=" + codigoPostal
				+ ", pais=" + pais + ", nombreContacto=" + nombreContacto + ", cargoContacto=" + cargoContacto
				+ ", mail=" + mail + ", telefono=" + telefono + ", codigoContable=" + codigoContable
				+ ", monedaPorDefecto=" + monedaPorDefecto + ", tipoIVA=" + tipoIVA + ", tipoPago=" + tipoPago
				+ ", plazoPago=" + plazoPago + ", numeroCuenta=" + numeroCuenta + "]";
	}
}